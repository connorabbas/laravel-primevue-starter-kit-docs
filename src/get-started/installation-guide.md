...
If you want more flexibility and already have knowledge of Docker (with Docker Compose), this starter kit provides a streamlined [Docker development setup](/development/docker) to get you up and running in no time.
